...
public class Runfile {
    ...
    /**
     * Get a filewriter to write the project name.
     *
     * @param project     The folder of the project
     * @param projectName The project name as a string
     * @return The filewriter used to write
     * @throws IOException Throws an io exception in case a file related operation goes poorly.
     */
    @NotNull
    public static FileWriter getFileWriter(File project, String projectName) throws IOException {
     ...
     */
    @NotNull
    public static File getFile(String projectName) {
     ...
     */
    public static String getYamlInfo(File yamlfile, File projectFolder) throws FileNotFoundException {

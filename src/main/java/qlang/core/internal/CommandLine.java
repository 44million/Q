    ...
    public String exec(String[] args, String fpath) {
        ...
        if (args.length >= 1) {
            if (args.length == 1 && !args[0].startsWith("-")) {
                ...
                if (args.length == 1) {
                    Log.log(Log.Severity.FATAL, "Flag `--moreinfo` requires field `<flag>`. See `q --help` for a list of flags.");
                }
                ...
                try {
                    Utilities.copyDirectory(exe.getPath(), System.getProperty("user.home") + "/.q/");
                            ...
                            switch (ary[i]) {
                                ...
                                case "uscript" -> {
                                    if (next.equals("--makefile") || next.equals("-m")) {
                                        ...
                                        FileWriter fw = getFileWriter(newf, Utilities.updateScript);
                                        fw.close();
                                        ...
                                        System.out.println(Utilities.updateScript);
                                    } else {

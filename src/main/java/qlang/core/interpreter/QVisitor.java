...
public interface QVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by {@link QParser#module}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitModule(QParser.ModuleContext ctx);

    /**
     * Visit a parse tree produced by {@link QParser#modStatement}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitModStatement(QParser.ModStatementContext ctx);

    /**
     * Visit a parse tree produced by {@link QParser#moduleReference}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitModuleReference(QParser.ModuleReferenceContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link QParser#nativeFunction}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitNativeFunction(QParser.NativeFunctionContext ctx);

...
public interface QListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link QParser#javajuice}.
     *
     * @param ctx the parse tree
     */
    void enterJavajuice(QParser.JavajuiceContext ctx);

    /**
     * Exit a parse tree produced by {@link QParser#javajuice}.
     *
     * @param ctx the parse tree
     */
    void exitJavajuice(QParser.JavajuiceContext ctx);

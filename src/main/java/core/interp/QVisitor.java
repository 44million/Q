...
public interface QVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by {@link QParser#objFunctionDecl}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitObjFunctionDecl(QParser.ObjFunctionDeclContext ctx);
     ...
     * @return the visitor result
     */
    T visitListCreateStatement(QParser.ListCreateStatementContext ctx);

    /**
     * Visit a parse tree produced by {@link QParser#listAddStatement}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitListAddStatement(QParser.ListAddStatementContext ctx);

    /**
     * Visit a parse tree produced by {@link QParser#listRemoveStatement}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitListRemoveStatement(QParser.ListRemoveStatementContext ctx);

    /**
     * Visit a parse tree produced by {@link QParser#osExecStatement}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitOsExecStatement(QParser.OsExecStatementContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link QParser#stopwatchStatement}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitStopwatchStatement(QParser.StopwatchStatementContext ctx);
